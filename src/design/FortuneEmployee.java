...
public class FortuneEmployee extends EmployeeInfo implements Employee{
    ...
    /**
     ...
     EmployeeInfo class to use fields and attributes. Demonstrate as many methods as possible to use with
     proper business work flow. Try to think like a Software Architect/Developer. This application should
     provide basic employee information services
